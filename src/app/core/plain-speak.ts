import { ActivityHint, Advisory, MarineSnapshot, SeaMood, SeaStory } from './models';
...
export function wildlifeLine(name: string, mood: SeaMood | undefined, whales: boolean): string {
  const season = whales
